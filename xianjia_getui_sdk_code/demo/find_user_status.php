...
$result = $App->find_user_status($inputdata);
echo json_encode    ($result);  

// 使用方法  cd /ocr/code/demo   &&  php82 test.php 
 
// yx-dev@Mac xianjia_getui_sdk % php82 ./xianjia_getui_sdk_code/demo/find_user_status.php  
// {"code":0,"network_status":200,"msg":"success","data":{"1813fd551854b2d459a0b73441ffe08b":{"status":"online"}}}%                                           
