...
$result = $App->find_alias($inputdata);
// var_dump( $result);  
// exit();
...
//  php82 ./demo/find_alias.php 
// yx-dev@yx-devdeMacBook-Air xianjia_getui_sdk_code % php82 ./demo/find_alias.php     
// {"code":0,"network_status":200,"msg":"success","data":{"alias":"su-dev-android-app"}}%  
