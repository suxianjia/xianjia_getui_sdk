...
$result = $App->find_report_user_date($inputdata);
// var_dump( $result);  
// exit();
echo json_encode    ($result);  

// 使用方法  cd /ocr/code/demo   &&  php82 test.php  
// yx-dev@Mac demo % php82 find_report_user_date.php
//  yx-dev@Mac demo % php82 find_report_user_date.php
// {"code":0,"network_status":200,"msg":"success","data":{"2025-07-23":{"register_num":0,"active_num":1,"online_num":1,"accumulative_num":560}}}%           
// yx-dev@Mac demo % 